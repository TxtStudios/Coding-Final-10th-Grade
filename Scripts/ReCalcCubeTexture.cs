...
THIS IS NOT MY CLASS. This class makes the block texture on the cube not stretch, and instead 
repeat to make the floor without having to place each cube indicidually. This is done by changing 
the cubes UV map.
